...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#' Add together two numbers.}
\hlcom{#' }
\hlcom{#' @param formula, }
\hlcom{#' @param Y~X1+...+Xn, }
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(neuralnet\_model): object 'neuralnet\_model' not found}}\end{kframe}
\end{knitrout}
\begin{figure}[h!]
\centering
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in predict(neuralnet\_model, iris\_test): object 'neuralnet\_model' not found}}\begin{alltt}
\hlkwd{table}\hlstd{(iris_test}\hlopt{$}\hlstd{Species,} \hlkwd{apply}\hlstd{(neuralnet_prediction,} \hlnum{1}\hlstd{, which.max))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in table(iris\_test\$Species, apply(neuralnet\_prediction, 1, which.max)): object 'iris\_test' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .External2(C\_savehistory, file): 'savehistory' can only be used in Rgui and Rterm}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean(pred.label.keras != as.vector(data\_df\$test\$Species)): object 'pred.label.keras' not found}}\end{kframe}
\end{knitrout}
and the time it took to train is :
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'time\_fnn\_keras' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'acc\_h2o' not found}}\end{kframe}
\end{knitrout}
and the time it took to train is :
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'time\_fnn\_h2o' not found}}\end{kframe}
\end{knitrout}
\subsubsection{CNN}
\subsubsection{RNN}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean(pred.label.mxnet != as.vector(data\_df\$test\$Species)): object 'pred.label.mxnet' not found}}\end{kframe}
\end{knitrout}
and the time it took to train is :
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'time\_fnn\_mxnet' not found}}\end{kframe}
\end{knitrout}
