...
When the the is ready, it is time to create the FFN. As an analogy, the keras model should be constructed like a Lego toy game. It starts from the input and goes all the way to the output.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
==========================================================================
\hlkwd{dense} (Dense)                    (None, 8)                    32          
__________________________________________________________________________
\hlkwd{dense_1} (Dense)                  (None, 3)                    27          
__________________________________________________________________________
\hlkwd{dense_2} (Dense)                  (None, 8)                    32          
__________________________________________________________________________
\hlkwd{dense_3} (Dense)                  (None, 3)                    27          
__________________________________________________________________________
\hlkwd{dense_4} (Dense)                  (None, 8)                    32          
__________________________________________________________________________
\hlkwd{dense_5} (Dense)                  (None, 3)                    27          
==========================================================================
Total params: 177
...
\hlstd{imdb} \hlkwb{<-} \hlkwd{dataset_imdb}\hlstd{(}\hlkwc{maxlen} \hlstd{= maxlen )}
\hlstd{imdb_hack} \hlkwb{<-} \hlkwd{dataset_imdb}\hlstd{(}\hlkwc{maxlen} \hlstd{=} \hlnum{150} \hlstd{)}
\hlstd{imdb}\hlopt{$}\hlstd{test}
...
[1] \hlstr{"<START> real cool smart movie i loved sheedy\hlstr{'s colors especially the purple car alice drummond is wise and wonderful as stella i liked sheedy'}s reference to how her face had gotten fatter the roadside dance scene is brilliant really liked this one"}
\end{alltt}
\end{kframe}
\end{knitrout}
