...
\subsubsection{RSNNS}
\paragraph{Description}
This package a mostly use ... \cite{RSNNS2019}
\paragraph{Pros}
\paragraph{Cons}
...
\end{comment}
\paragraph{Description}
This package a mostly use ... \cite{deepnet2015}
\paragraph{Pros}
\paragraph{Cons}
...
\subsubsection{brnn}
\paragraph{Description}
This package a mostly use ... \cite{brnn2020}
\paragraph{Pros}
\paragraph{Cons}
\begin{comment}
looks deprecated
...
\begin{comment}
Take information and adress references
